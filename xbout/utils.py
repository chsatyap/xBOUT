...
def _get_bounding_surfaces(ds, coords):
    ...
    if not remaining_regions:
        ...
        for r in checked_regions:
            if (
                ...
                and ds.regions[r].connection_lower_y is None
                and ds.regions[r].connection_upper_y is None
    ...
    for r in remaining_regions:
        region = ds.regions[r]
        if (
            region.connection_lower_y is not None
            or region.connection_outer_x is not None
            or region.connection_upper_y is not None
            or region.connection_inner_x is not None
        ):
            raise ValueError(
